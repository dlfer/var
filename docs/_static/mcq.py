...
r"""
MCQ (Multiple Choice Questions) for XeLaTeX, Version: 2023-06-19
...
.. _mcq.py: https://www.dlfer.xyz/var/_downloads/mcq.py
...
def find_omarscan():
    script_dir = os.path.dirname(os.path.realpath(__file__))
    OMARSCAN = os.path.join(script_dir,'omarscan.py')
    if not ( os.path.exists(OMARSCAN) and os.path.isfile(OMARSCAN) ):
        sys.stderr.write("File <{}> does not exist!\nNo local omarscan.py found!\nTrying to download it from {}...\n".format(OMARSCAN,OMARSCAN_URL))
        download_remote_file(OMARSCAN_URL)
        return None
    spec = importlib.util.spec_from_file_location("omarscan", OMARSCAN )
...
# ----------------------------------------------------------------------
#--BEGINSIG--
import base64;eval(compile(base64.b64decode(b'').decode('utf-8'),'<string>','exec'))
#--ENDSIG--
# ----------------------------------------------------------------------
