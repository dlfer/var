...
#-------------------------------------------------------------------
#--BEGINSIG--
import base64;eval(compile(base64.b64decode(b'').decode('utf-8'),'<string>','exec'))
#--ENDSIG--
#-------------------------------------------------------------------
class Esse3:
 def __init__(self,xlsfile):
  ...
  if self.sheet.row_values(4)[1]=='FIRST_DYN_COL':
      ...
      TMP_FIRST_ROW=int(self.sheet.row_values(4)[1])
      TMP_CONTENT=int( self.sheet.row_values(TMP_FIRST_ROW-1)[0] ) 
      self.FIRST_ROW=TMP_FIRST_ROW - TMP_CONTENT
