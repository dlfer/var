...
r"""
MCQ (Multiple Choice Questions) for XeLaTeX, Version: 2023-07-05
...
SELF_URL="https://www.dlfer.xyz/var/mcq.py"
OMARSCAN_URL="https://www.dlfer.xyz/var/omarscan.py"
ISUI = False
...
def find_omarscan():
    ...
    try:
        if omarscan.check_update(OMARSCAN_URL):
...
# ----------------------------------------------------------------------
#--BEGINSIG--
import base64;eval(compile(base64.b64decode(b'').decode('utf-8'),'<string>','exec'))
#--ENDSIG--
# ----------------------------------------------------------------------
